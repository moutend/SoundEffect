...
sox -v 1.375 -r 22050 -c 1 ./src/chime.aif -b 16 ./wav/chime.wav speed 4.5 trim 16.25 0.75 fade h 0 0.69 0.69
...
sox -v 1.5 -r 22050 ./src/castanets.wav -b 16 ./wav/password.wav trim 0.005 0.375 speed 4.75 pitch "-240" fade t 0 0.05 0.05
